...
from qtt.instrument_drivers.virtualAwg.awgs.ZurichInstrumentsHDAWG4 import ZurichInstrumentsHDAWG4
...
class VirtualAwg(Instrument):
    ...
    def __set_hardware(self, awgs):
        ...
        for awg in awgs:
            ...
            elif type(awg).__name__ == 'ZIHDAWG4':
                self.awgs.append(ZurichInstrumentsHDAWG4(awg))
            else:
